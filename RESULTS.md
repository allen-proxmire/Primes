...
- **[verified/emp] Prime-triangle angle is a rescaled gap:** $\alpha_n = \arctan(p_n/p_{n+1}) \approx 45° - \frac{90}{\pi}\frac{g_n}{p_{n+1}}$ — angles rise to a $45°$ ceiling in gap-family arcs (twins on top, never reaching it). The wobble is ~99% universal (a $33\ln p/p$ envelope, a $1/3$ runs constant); the lone ~1% prime signal is consecutive-gap anti-correlation $-0.05$ = the Hardy–Littlewood wheel, built prime-by-prime. → [Angle Wobble](2_One_Wheel_Many_Shadows/PG_Angle_Wobble.md)
