...
- **~~R6 — is the hexagonal norm meaningful?~~ CLOSED 2026-09-20 — answered: divisibility of the form by 3 is exactly a mod-6 residue repeat, [balance ratio §2.1](../2_One_Wheel_Many_Shadows/PG_Balance_Ratio_And_Koide.md). (Marked closed 2026-09-21.)** Original question: g1² + g1·g2 + g2² is the Eisenstein norm form; the wheel's first filter is mod 6, also hexagonal. Probably a pun. Cheap to test: does the form's value distribution over real gaps differ from the null in a way that references 6? Low priority. Flagged as open in [balance ratio §9](../2_One_Wheel_Many_Shadows/PG_Balance_Ratio_And_Koide.md).
...
- **~~The v2 files are drafts, not replacements.~~ CLOSED 2026-09-20.** The v2s were promoted to the canonical filenames and the pre-September originals of four papers moved to [`superseded/`](../2_One_Wheel_Many_Shadows/superseded/); PRIMES_MAP and RESULTS updated at the time. (Marked closed 2026-09-21; the item had gone stale.)
